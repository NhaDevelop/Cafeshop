...
export interface OrderItem  { id: string; menuItemId: string; name: string; quantity: number; price: number; subtotal: number; note?: string; size?: string }
...
export interface CreateOrderItemDTO { menuItemId: string; quantity: number; note?: string; size?: string }
